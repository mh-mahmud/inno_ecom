                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="fv-row mb-3">
                                    ...
                                    <textarea class="form-control form-control-sm form-control-solid editor"
                                        name="job_description" rows="2">{{ old('job_description') }}</textarea>
                            ...
                            <div class="col-md-6">
                                <div class="fv-row mb-3">
                                    ...
                                    <textarea class="form-control form-control-sm form-control-solid editor"
                                        name="requirements" rows="2">{{ old('requirements') }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="fv-row mb-3">
                                    ...
                                    <select class="form-control form-control-sm form-control-solid" name="status" required>
