...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Nov 17, 2024 at 12:54 PM
...
CREATE TABLE IF NOT EXISTS `logs` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=224 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `products` (`id`, `name`, `description`, `product_specification`, `how_to_order`, `return_policy`, `product_short_message`, `product_type`, `product_cost`, `product_value`, `product_code`, `img_path`, `img_path_2`, `img_path_3`, `img_path_4`, `img_path_5`, `img_path_6`, `xxs_stock`, `xs_stock`, `s_stock`, `m_stock`, `l_stock`, `xl_stock`, `xxl_stock`, `xxxl_stock`, `xxxxl_stock`, `colors`, `status`, `created_by`, `updated_by`, `created_at`, `updated_at`) VALUES
(20, 'crm', 'Test case reviews are just as important during test automation as they are during manual testing. In fact, they can be even more critical in the automation context because once test cases are automated, any defects in the test cases can be repeated quickly and consistently.', NULL, NULL, NULL, NULL, 0, 120000.00, 12.00, '0001234', '', NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, 0, 0, 0, 0, NULL, 1, 1, NULL, '2024-10-27 22:19:24', '2024-10-30 04:53:35'),
(21, 'call center solution', 'Imagine that every QA member maintains their own document for test cases. This will only lead to confusion when you work as a team, and there is a high chance of losing track of the test plan and execution. If you don’t maintain a proper test case repository, then it might lead to missed execution of test cases, patchy test coverage, and, eventually, poor product quality. That is why maintaining a test case repository is highly important for medium to large projects.', NULL, NULL, NULL, NULL, 0, 50.00, 150.00, '000123456', '', NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, 0, 0, 0, 0, NULL, 1, 1, NULL, '2024-10-27 22:21:29', '2024-10-28 03:01:32'),
(22, 'ticket system', 'Imagine that every QA member maintains their own document for test cases. This will only lead to confusion when you work as a team, and there is a high chance of losing track of the test plan and execution. If you don’t maintain a proper test case repository, then it might lead to missed execution of test cases, patchy test coverage, and, eventually, poor product quality. That is why maintaining a test case repository is highly important for medium to large projects.\r\n\r\nBesides, testing is a repeatable procedure. Reusing test cases is one of the major advantages, as it helps save time. In large projects, frequent testing will be required. And, when you have a test case repository, it will let you reuse your previous test resources wherever required and accelerate the testing process. Also, maintaining a test repository is quite easy!\r\n\r\nHere are some of the top benefits of a test case repository:\r\n\r\nAll the authorized test cases will be stored in a test case repository.\r\nQA team will always have a complete backup of the test case repository in case of a crash that might affect the application.\r\nIt can be easily updated whenever required.\r\nIt helps save time.\r\nTesters’ test case creation skills can be assessed on a performance basis.\r\nIt helps achieve comprehensive test coverage.\r\nIt helps with test reports.\r\nThe status of test cases can be easily displayed via a chart with values like pass, fail, or not tested.\r\nBoosts application quality and knowledge.', NULL, NULL, NULL, NULL, 3, 200.00, 300.00, '001234567890', '', NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, 0, 0, 0, 0, NULL, 1, 1, NULL, '2024-10-27 22:26:02', '2024-10-28 22:23:40'),
(23, 'kbs', 'Imagine that every QA member maintains their own document for test cases. This will only lead to confusion when you work as a team, and there is a high chance of losing track of the test plan and execution. If you don’t maintain a proper test case repository, then it might lead to missed execution of test cases, patchy test coverage, and, eventually, poor product quality. That is why maintaining a test case repository is highly important for medium to large projects.\r\n\r\nBesides, testing is a repeatable procedure. Reusing test cases is one of the major advantages, as it helps save time. In large projects, frequent testing will be required. And, when you have a test case repository, it will let you reuse your previous test resources wherever required and accelerate the testing process. Also, maintaining a test repository is quite easy!\r\n\r\nHere are some of the top benefits of a test case repository:\r\n\r\nAll the authorized test cases will be stored in a test case repository.\r\nQA team will always have a complete backup of the test case repository in case of a crash that might affect the application.\r\nIt can be easily updated whenever required.\r\nIt helps save time.\r\nTesters’ test case creation skills can be assessed on a performance basis.\r\nIt helps achieve comprehensive test coverage.\r\nIt helps with test reports.\r\nThe status of test cases can be easily displayed via a chart with values like pass, fail, or not tested.\r\nBoosts application quality and knowledge.', NULL, NULL, NULL, NULL, 1, 100.00, 250.00, '1234509867', '', NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, 0, 0, 0, 0, NULL, 1, 1, NULL, '2024-10-28 01:02:23', '2024-10-28 03:02:14'),
(24, 'ems', 'product in the market, it’s essential to test whether both the frontend and backend of the application are working correctly. Frontend testing is the testing of the user interface visible to the user by which users interact with the application. In contrast, backend testing is about testing the actual database and server logic under the hood, which is not visible to the application users.\r\n\r\nIn this article, you will learn about fronted and backend testing and the difference between both tests. You will also learn about the various tools and techniques used in frontend and backend testing.', NULL, NULL, NULL, NULL, 0, 12345678910.00, 12345678.00, '0021111', 'Capture_1730354206.PNG', NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, 0, 0, 0, 0, NULL, 1, 1, 1, '2024-10-29 04:34:50', '2024-10-30 23:56:46'),
(26, 'Social', NULL, NULL, NULL, NULL, NULL, 3, 1200.00, 15000.00, '0023', 'andi-rieger-vfEqA8sKe6A-unsplash_1730358844_1730865590.jpg', NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, 0, 0, 0, 0, NULL, 1, 69, 69, '2024-11-06 03:59:50', '2024-11-06 04:00:13');
...
(1, NULL, 'root', 'Khan1', 'Riyad', 'khan@gmail.com', '01731415537', 'admin', NULL, '150-26_1726559191.jpg', NULL, '5', NULL, '$2y$12$W9G7uVmQHVeqsgNQrmpvtueBNg6QS4JzgaXwNixuZ8mv9KV5x57yi', NULL, '1', '2024-05-19 22:24:44', '2024-09-24 04:20:40'),
