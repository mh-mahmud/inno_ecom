...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Nov 24, 2024 at 12:18 PM
...
CREATE TABLE IF NOT EXISTS `logs` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=225 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(224, 1, NULL, 'Products', 'Add Product fgrvrdsgrgf', 'fgrvrdsgrgf', 1, '2024-11-24 10:56:50', '2024-11-24 10:56:50');
...
CREATE TABLE IF NOT EXISTS `orders` (
  `id` int NOT NULL AUTO_INCREMENT,
  `invoice_no` varchar(20) COLLATE utf8mb3_unicode_ci NOT NULL,
  ...
  `area` enum('Inside Dhaka','Outside Dhaka') COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `address` text COLLATE utf8mb3_unicode_ci,
  `product_code` varchar(20) COLLATE utf8mb3_unicode_ci NOT NULL,
  `product_name` varchar(255) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `product_color` varchar(50) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `product_size` varchar(10) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  ...
  `status` enum('New','Pending','Processing','Completed','Cancelled') COLLATE utf8mb3_unicode_ci DEFAULT 'New',
...
(1, NULL, 'root', 'Khan1', 'Riyad', 'khan@gmail.com', '01731415537', 'admin', NULL, '2_1732442253.png', NULL, '5', NULL, '$2y$12$JRvyCWa35X6er4gfDJcYbOTj1X.HlQa2xeYUnd7sZyNA2OR4Xpgye', NULL, '1', '2024-05-19 22:24:44', '2024-11-24 09:57:33'),
